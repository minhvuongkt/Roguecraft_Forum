    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">
          Chào mừng đến với ForumChat
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          Nền tảng kết hợp diễn đàn và trò chuyện trực tuyến. Tham gia cộng đồng và kết nối với mọi người.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <Card className="overflow-hidden hover:shadow-lg transition-shadow">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl">Diễn đàn thảo luận</CardTitle>
            <CardDescription>
              Tham gia các cuộc thảo luận, đặt câu hỏi và chia sẻ kiến thức với cộng đồng
            </CardDescription>
          </CardHeader>
        ...
        <Card className="overflow-hidden hover:shadow-lg transition-shadow">
          <CardHeader className="pb-4">
            <CardTitle className="text-2xl">Chat trực tuyến</CardTitle>
            <CardDescription>

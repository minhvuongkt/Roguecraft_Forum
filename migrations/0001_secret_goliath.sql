...
ALTER TABLE `comments` ADD CONSTRAINT `comments_topic_id_topics_id_fk` FOREIGN KEY (`topic_id`) REFERENCES `topics`(`id`) ON DELETE no action ON UPDATE no action;
...
ALTER TABLE `topic_likes` ADD CONSTRAINT `topic_likes_topic_id_topics_id_fk` FOREIGN KEY (`topic_id`) REFERENCES `topics`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `topic_likes` ADD CONSTRAINT `topic_likes_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE no action ON UPDATE no action;
